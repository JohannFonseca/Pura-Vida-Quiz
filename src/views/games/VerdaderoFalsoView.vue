...
const shareToWhatsapp = () => {
  const p = percentage.value
  const msg = `Saqué ${p}% en Verdadero o falso sobre Mitos 🇨🇷 ¿Cuánto sacás vos? Retame en: ${window.location.origin}/quizzes/verdadero-falso`
  ...
  <div class="view-container">
    ...
    <div class="game-wrapper" :class="{ 'shake-animation': gameState === 'validando' && !choiceMade?.isCorrect }">
      ...
      <div v-if="gameState === 'inicio'" class="inicio-screen">
        ...
        <button @click="$router.push('/quizzes')" class="btn-secondary">Regresar</button>
      </div>
      ...
      <div v-if="gameState === 'resultados'" class="result-screen">
        ...
        <!-- COMPONENTE REUTILIZABLE PARA REGISTRAR PUNTOS -->
        <ScoreRegistration :score="userScore" gameName="Verdadero o Falso" />
        ...
        <div class="nav-bottom">
          ...
          <button @click="$router.push('/quizzes')" class="btn-sub">Ir a otro Juego</button>
        </div>
